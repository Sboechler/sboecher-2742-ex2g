...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.context = this;
        loadSensorReadings();
        SensorReadingAdapter adapter = new SensorReadingAdapter(this, R.layout.sensor_reading_recycler_item, this.sensorReadings);
...
// **************** Property Monitor page down ****************************
//        String url = "http://204.77.50.53/propertymonitor/api/sensorreadings";
